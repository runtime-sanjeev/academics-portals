...
import LineSkelton from "../components/Skelton/LineSkelton";
...
function Student() {
    ...
    const isOptionDisabled = (code) => {
        return Object.values(selectedStudents).includes(code);
    };
    ...
    useEffect(() => {
        const fetchStateData = async () => {
            try {
                const stateResponse = await axiosClient.get("getStates"); // API for fetching states
                setStates(stateResponse.data.states); // Set States

                console.log("States:", stateResponse.data.states);
    ...
    const handleStateChange = (e) => {
        setselectedStudents({
            ...selectedStudents,
            present_state: e.target.value, // Update selected district
        });
    };
                    ...
                    <div className="max-w-[1000px] mx-auto p-6  shadow-lg rounded-xl">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start space-x-4">
                                ...
                                <div className="w-2/3">
                                    {loading ? (
                                        <LineSkelton height={40} />
                                    ) : (
                                        <input
                                            type="text"
                                            name="student_name"
                                            value={
                                                selectedStudents.student_name
                                            }
                                ...
                                <div className="w-2/3">
                                    {loading ? (
                                        ...
                                        <input
                                            ...
                                            name="address_line1"
                                            value={
                                                selectedStudents.address_line1
                                            }
                                            onChange={handleChange}
                                ...
                                <div className="w-2/3">
                                    {loading ? (
                                        ...
                                        <input
                                            ...
                                            name="address_line2"
                                            value={
                                                selectedStudents.address_line2
                                            }
                                            onChange={handleChange}
                                            className="w-full  p-2 border rounded"
                                        />
                                ...
                                <div className="w-2/3">
                                    {loading ? (
                                        ...
                                        <select
                                            name="present_state"
                                            value={
                                                selectedStudents.present_state_code
                                            }
                                ...
                                <div className="w-2/3">
                                    {loading ? (
                                        ...
                                        <input
                                            ...
                                            name="student_email"
                                            value={
                                                selectedStudents.student_email
                                            }
                                            onChange={handleChange}
                                            className="w-full  p-2 border rounded"
                                        />
                                ...
                                <div className="w-2/3">
                                    {loading ? (
                                        ...
                                        <select
                                            ...
                                            value={
                                                selectedStudents.subject_mil_code
                                            }
                                            onChange={handleChange}
                                            className="w-full p-2 border rounded"
                                        >
                                            ...
                                            {subjects.language_one.map(
                                                (subject) => (
                                                    <option
                                                        key={subject.sub_code}
                                                        value={subject.sub_code}
                                                        disabled={isOptionDisabled(subject.sub_code)}
                                                        style={{
                                                            color: isOptionDisabled(subject.sub_code)
                                                                ? "red"
                                                                : "black",
                                                        }}
                                                    >
                                ...
                                <div className="w-2/3">
                                    {loading ? (
                                        ...
                                        <select
                                            ...
                                            value={
                                                selectedStudents.subject_lieu_code
                                            }
                                            onChange={handleChange}
                                            className="w-full p-2 border rounded"
                                        >
                                ...
                                <div className="w-2/3">
                                    {loading ? (
                                        ...
                                        <select
                                            ...
                                            value={
                                                selectedStudents.subject_elective_code
                                            }
                                            onChange={handleChange}
                                            className="w-full p-2 border rounded"
                                        >
